...
def get_opts():
    ...
    parser.add_argument(
        "--exp_name", type=str, default="replica", help="Experiment name",
    )
    parser.add_argument(
        "--dataset_name",
        type=str,
...
def batched_inference(
    models, embeddings, rays, N_samples, N_importance, use_disp, chunk, white_back
):
...
if __name__ == "__main__":
    ...
    imgs = []
    psnrs = []
    dir_name = f"results/{args.exp_name}/{args.dataset_name}/{args.scene_name}"
